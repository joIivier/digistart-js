...
// ['Ali', 'Nora', 'Jean', 'Carole', 'Ibrahim', 'Joseph'] length 6
// ['Ali', 'Nora', 'Jean', 'Carole', 'Ibrahim'] 5
// ['Ali', 'Nora', 'Jean', 'Carole'] 4
// ['Ali', 'Nora', 'Jean'] 3
// ['Ali', 'Nora'] 3
// ['Ali'] 1
// [] 0
...
var randomVariable = Math.random() * 70;
console.log(randomVariable);
while(randomVariable < 50) {
    console.log(Date.now());
    randomVariable = Math.random() * 70;
    console.log(randomVariable);
}